...
def dirichlet_split_noniid(
    ...
    # print("ori_dataset[0].targets============", ori_dataset[0].targets)
    # print("type(ori_dataset[0].targets)============", type(ori_dataset[0].targets))
    # print("ori_dataset[0].targets============", ori_dataset[0].targets)
    # print("ori_dataset[0].data============", ori_dataset[0].data)
    MIN_SIZE = 0
